...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 09, 2024 lúc 07:55 AM
...
(1, 'Trang Sức Cưới', 'upload/danhmuc1.jpg', 0),
(2, 'Trang Sức Vàng', 'upload/danhmuc2.jpg', 0),
(3, 'Trang Sức Bạc', 'upload/danhmuc3.jpg', 2),
(4, 'Trang Sức Kim Cương', 'duong_dan_anh_kim_cu.jpg', 0),
(5, 'Trang Sức Ngọc Trai', 'duong_dan_anh_ngoc_trai.jpg', 1),
(6, 'Trang Sức Đá Quý', 'duong_dan_anh_da_quy.jpg', 2),
(7, 'Trang Sức Bạch Kim', 'duong_dan_anh_bach_kim.jpg', 2),
(8, 'Trang Sức Ruby', 'duong_dan_anh_ruby.jpg', 0);
...
(1, '2024-04-07', 4600.00, 1),
(2, '2024-04-08', 4650.00, 2),
(3, '2024-04-09', 4625.00, 3),
(4, '2024-04-10', 3600.00, 4),
(5, '2024-04-11', 6550.00, 5),
(6, '2024-04-12', 7825.00, 6),
(7, '2024-04-13', 8000.00, 7),
(8, '2024-04-14', 1250.00, 8),
(9, '2024-04-15', 5625.00, 9);
...
--
-- AUTO_INCREMENT cho bảng `chitietgiaodich`
--
ALTER TABLE `chitietgiaodich`
  MODIFY `Ma_GD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `don_gia`
  MODIFY `id_gia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
