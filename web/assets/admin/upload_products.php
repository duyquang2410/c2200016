...
if ($uploadOk == 1) {
  ...
  $sql_sanpham = "INSERT INTO SANPHAM (Ma_SP , Ma_DM , HinhAnh_SP, Ten_SP, TrongLuong_Sp, MoTa_SP, soluong) 
  ...
  $sql_phieunhap = "INSERT INTO phieunhap (Ma_PN , Ma_NV , NgayLap_PN) 
                    VALUES ('$pn_id', '$nvid', NOW())";
